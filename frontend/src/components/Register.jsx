        ...
        >
          ...
          <StyledForm onSubmit={handleSubmit} noValidate autoComplete="off">
            ...
            <Box>
              ...
              <TextField
                ...
                sx={{
                  ...
                  "& input::placeholder": {
                    fontFamily:
                      'PixelSplitter, "Courier New", Courier, monospace',
                  },
                }}
              />
            </Box>
            ...
            <Box>
              ...
              >
                <option value="pantser" style={{ padding: "12px" }}>
                  PANTSER
                </option>
                <option value="plotter" style={{ padding: "12px" }}>
                  PLOTTER
                </option>
              </TextField>
            </Box>
            ...
            <Box sx={{ display: "flex", gap: 4, my: 4 }}>
              ...
              >
                HAVE AN ACCOUNT?{" "}
                <span style={{ color: "rgba(216, 246, 81, 1)" }}> LOG IN</span>
              </Button>
              <Button
                type="submit"
                variant="contained"

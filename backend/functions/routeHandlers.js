...
In this example story, for instance, in CHARACTER, God and the Serpent were missing as characters.
Ensure that in every response, you include how the story is shaping up and keep the cards being analyzed based on the STORY, because sometimes, when the response is just a question or something else, the cards are generated reflecting the AI's question and not the story itself.`
        }],
